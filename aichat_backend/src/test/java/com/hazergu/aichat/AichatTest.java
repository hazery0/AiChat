package com.hazergu.aichat;

import com.hazergu.aichat.service.AiManage;
...
//
//        BotChatCompletionRequest streamChatCompletionRequest = BotChatCompletionRequest.builder().botId("bot-20251205102309-85rgn").messages(streamMessages).build();
//
//        service.streamBotChatCompletion(streamChatCompletionRequest).doOnError(Throwable::printStackTrace).blockingForEach(choice -> {
